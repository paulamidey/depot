# RailsAdmin config file. Generated on September 23, 2013 15:17
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Depot', 'Admin']
...
#  config.current_user_method { current_user } # auto-generated
  ...
  # config.excluded_models = ['Cart', 'LineItem', 'Order', 'Product']

  # Include specific models (exclude the others):
  # config.included_models = ['Cart', 'LineItem', 'Order', 'Product']
